...
age_str <- dplyr::if_else(age_grp == 0, "60-74 years", "75+ years")

# Abbildung Trends in func. Limit. -----
par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_fun_lim_m, digits = 2, xlab = sprintf("Trends in Functional Limitations (male, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")

par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_fun_lim_w, digits = 2, xlab = sprintf("Trends in Functional Limitations (female, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")
...
par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_abs_m, digits = 2, xlab = sprintf("Absolute Inequalities (male, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")

par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_abs_w, digits = 2, xlab = sprintf("Absolute Inequalities (female, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")
...
par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_rel_m, digits = 3, xlab = sprintf("Relative Inequalities (male, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")

par(font = 1, mar = c(4, 4, 1, 2))
forest(ma_rel_w, digits = 3, xlab = sprintf("Relative Inequalities (female, %s)", age_str), order = land_reihe, mlab = "average")
par(font = 2)
text(x = grconvertX(-.025, "npc"), grconvertY(.96, "npc"), labels = "Country")
text(x = grconvertX(.975, "npc"), grconvertY(.96, "npc"), labels = "B (CI)")
